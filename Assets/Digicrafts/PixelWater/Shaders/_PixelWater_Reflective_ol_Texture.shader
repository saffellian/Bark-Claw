Shader "Digicrafts/PixelWater/Reflective(One Light)(Texture)"
{
	Properties
	{		
		// Pattern/Colors
...
//		_ColorNoiseScale ("_NoiseScale", Range(1,100)) = 10
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature PIXEL_WATER_FOAM
			#pragma shader_feature PIXEL_WATER_REFLECMAP
			#define PIXEL_WATER_REFLECTIVE
