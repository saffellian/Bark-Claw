...
namespace AmbientSkies
{
    ...
    public class RealtimeEmissionSetup : MonoBehaviour
    {
        ...
        //Scene Renderers
        public Renderer[] m_sceneRenderers;
                        ...
                        if (m_emissiveMaterials != null)
                        {
                            ...
                            foreach (Material mats in m_emissiveMaterials)
                            {
                                ...
                                if (m_renderPipelineSettings == AmbientSkiesConsts.RenderPipelineSettings.HighDefinition)
                                {
                                    ...
                                    //For each one assign the paramater as off
                                    //mats.SetColor("_EmissiveColor", m_emissiveOn / 10);
                                }
                                else
                                {
                                    //For each one assign the paramater as off
                                    ...
                                    //For each one assign the paramater as off
                                    //mats.SetColor("_EmissionColor", m_emissiveOn / 18f);
                                }
                            }

                            if (m_sceneRenderers.Length > 0)
                            {
                                if (m_renderPipelineSettings == AmbientSkiesConsts.RenderPipelineSettings.HighDefinition)
                                {
                        ...
                        if (m_emissiveMaterials != null)
                        {
                            ...
                            foreach (Material mats in m_emissiveMaterials)
                            {
                                ...
                                if (m_renderPipelineSettings == AmbientSkiesConsts.RenderPipelineSettings.HighDefinition)
                                {
                                    ...
                                    //For each one assign the paramater as off
                                    mats.SetColor("_EmissiveColor", m_emissiveOff * 0);
                                }
                                else
                                {
                                    //For each one assign the paramater as off
                                    ...
                                    //For each one assign the paramater as off
                                    mats.SetColor("_EmissionColor", m_emissiveOff * 0);
                                }
                            }
                    ...
                    if (m_emissiveMaterials != null)
                    {
                        ...
                        foreach (Material mats in m_emissiveMaterials)
                        {
                            ...
                            if (m_renderPipelineSettings == AmbientSkiesConsts.RenderPipelineSettings.HighDefinition)
                            {
                                ...
                                //For each one assign the paramater as off
                                //mats.SetColor("_EmissiveColor", m_emissiveOn / 4f);
                            }
                            else
                            {
                                //For each one assign the paramater as off
