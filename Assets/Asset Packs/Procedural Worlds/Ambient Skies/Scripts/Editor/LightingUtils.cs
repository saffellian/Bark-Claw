...
namespace AmbientSkies
{
    ...
    public static class LightingUtils
    {
        ...
        public static void SetFromProfileIndex(AmbientLightingProfile profiles, int profileName, bool useDefaults)
        {
        ...
        /// <param name="useDefaults">Whether to load default settings or current user settings.</param>
        public static void SetFromProfileName(AmbientSkyProfiles profile, string profileName, bool useDefaults)
        {
            ...
            SetLightmapSettings(p, useDefaults);
        }
        ...
        public static void SetLightmapSettings(AmbientLightingProfile profile, bool useDefaults)
        {
