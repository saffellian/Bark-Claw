...
namespace AmbientSkies
{
    public class AmbientSkiesConsts : MonoBehaviour
    {
        ...
        public enum HDShadowQuality { Resolution64, Resolution128, Resolution256, Resolution512, Resolution1024, Resolution2048, Resolution4096, Resolution8192 }
        ...
        public enum PlatformTarget { DekstopAndConsoles, MobileAndVR }
        ...
        public enum SystemTypes { AmbientSkies, DefaultProcedural, ThirdParty }
