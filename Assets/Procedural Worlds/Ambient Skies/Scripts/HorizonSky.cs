...
namespace AmbientSkies
{
    ...
    public class HorizonSky : MonoBehaviour
    {
        ...
        public void UpdatePosition()
        {
            ...
            {
                m_isUpdatingPosition = true;
                m_HorizonSky.transform.localPosition = new Vector3(m_mainCamera.transform.position.x / 2f, m_mainCamera.transform.position.y - 45f, m_mainCamera.transform.position.z / 2f);
                m_storedUpdate = m_positionUpdate;
                m_isUpdatingPosition = false;
            }
