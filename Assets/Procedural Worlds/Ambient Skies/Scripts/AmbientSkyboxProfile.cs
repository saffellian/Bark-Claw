...
namespace AmbientSkies
{
    ...
    public class AmbientSkyboxProfile
    {
        ...
        [Header("HD Procedural Sky Settings")]
        public float defaultSunSize = 0.04f;
        public float defaultSunConvergence = 5f;
        public float defaultAtmosphereThickness = 1f;
        public Color32 defaultSkyTint = new Color32(128, 128, 128, 255);
        public float defaultSkyExposure = 0f;
        ...
        public Color32 skyTint = new Color32(128, 128, 128, 255);
        public float skyExposure = 0f;
        ...
        public void RevertToDefault()
        {
            ...
            sunConvergence = defaultSunConvergence;
            atmosphereThickness = defaultAtmosphereThickness;
            skyTint = defaultSkyTint;
            skyExposure = defaultSkyExposure;
        ...
        public void SaveCurrentToDefault()
        {
            ...
            defaultSunSize = sunSize;
            defaultSunConvergence = sunConvergence;
            defaultAtmosphereThickness = atmosphereThickness;
            defaultSkyTint = skyTint;
