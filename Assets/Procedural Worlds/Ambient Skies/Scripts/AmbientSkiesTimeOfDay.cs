...
//#if !WORLDAPI_PRESENT
    ...
    public class AmbientSkiesTimeOfDay : MonoBehaviour
    {
        ...
        [HideInInspector]
        public AmbientSkyboxProfile m_ambientSkyboxProfile;
        ...
        private void OnEnable()
        {
            ...
            {
                m_timeOfDayProfile.m_sunRotationAmount = m_ambientSkiesProfileVol1.sunRotationAmount;
                m_timeOfDayProfile.m_timeToAddOrRemove = m_ambientSkiesProfileVol1.timeToAddOrRemove;
                m_timeOfDayProfile.m_pauseTime = m_ambientSkiesProfileVol1.pauseTime;
                m_timeOfDayProfile.m_currentTime = m_ambientSkiesProfileVol1.currentTimeOfDay;
            }
        }
        ...
        private void OnDisable()
        {
            ...
            if (m_ambientSkiesProfileVol1 != null)
            {
                m_ambientSkiesProfileVol1.sunRotationAmount = m_timeOfDayProfile.m_sunRotationAmount;
                m_ambientSkiesProfileVol1.timeToAddOrRemove = m_timeOfDayProfile.m_timeToAddOrRemove;
                m_ambientSkiesProfileVol1.pauseTime = m_timeOfDayProfile.m_pauseTime;
                m_ambientSkiesProfileVol1.currentTimeOfDay = m_timeOfDayProfile.m_currentTime;
            }
        }
        ...
        private void Update()
        {
            ...
            else
            {
                ...
                if (m_ambientSkyboxProfile != null)
                {
                    m_ambientSkyboxProfile.skyboxRotation = m_timeOfDayProfile.m_sunRotation;
                }
            }
        ...
        public void AmbientSkiesSynchronization()
        {
            ...
            {                
                ...
                if (m_timeOfDayProfile.m_day >= 1 && m_timeOfDayProfile.m_month == 3)
                {
                    ...
                    m_ambientSkiesProfileVol1.currentSeason = AmbientSkiesConsts.CurrentSeason.Spring;
                }
                ...
                else if (m_timeOfDayProfile.m_day >= 1 && m_timeOfDayProfile.m_month == 6)
                {
                    ...
                    m_ambientSkiesProfileVol1.currentSeason = AmbientSkiesConsts.CurrentSeason.Summer;
                }
                ...
                else if (m_timeOfDayProfile.m_day >= 1 && m_timeOfDayProfile.m_month == 9)
                {
                    ...
                    m_ambientSkiesProfileVol1.currentSeason = AmbientSkiesConsts.CurrentSeason.AutumnFall;
                }
                ...
                else if (m_timeOfDayProfile.m_day >= 1 && m_timeOfDayProfile.m_month == 12)
                {
                    ...
                    m_ambientSkiesProfileVol1.currentSeason = AmbientSkiesConsts.CurrentSeason.Winter;
                }
            }
            else
            {
            ...
            else
            {
                ...
                if (volumeProfile != null)
                {
                    ...
                    if (volumeProfile.TryGet(out volumetricFog))
                    {
                        ...
                        volumetricFog.baseHeight.value = 35f;
                        volumetricFog.meanHeight.value = 4500f;              
                    ...
                    if (volumeProfile.TryGet(out lightingController))
                    {
                        ...
                        lightingController.indirectDiffuseIntensity.value = ambience;
                    }
                }            
            }   
#endif
        ...
        public void PauseTime(bool isTimePaused)
        {
            ...
            if (m_timeOfDayProfile.m_pauseTime)
            {
                ...
                m_ambientSkiesProfileVol1.pauseTime = false;
            }
            else
            {
                //Pause time
                m_timeOfDayProfile.m_pauseTime = true;
                m_ambientSkiesProfileVol1.pauseTime = true;
            }
        }
        ...
        {
            //Add time
            m_ambientSkiesProfileVol1.currentTimeOfDay += timeToAdd;
            m_timeOfDayProfile.m_currentTime = m_ambientSkiesProfileVol1.currentTimeOfDay;
        }
        ...
        {
            //Remove time
            m_ambientSkiesProfileVol1.currentTimeOfDay -= timeToRemove;
            m_timeOfDayProfile.m_currentTime = m_ambientSkiesProfileVol1.currentTimeOfDay;
        }
        ...
        public void RotateSunLeft(float rotationValue)
        {
            if (m_mainLight != null)
            {
                m_ambientSkiesProfileVol1.skyboxRotation -= rotationValue;
                m_timeOfDayProfile.m_sunRotation = m_ambientSkiesProfileVol1.skyboxRotation;
            }
        }
